...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Script By : Clover`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : Clover ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`كن رافع رأسك دائما ولا تستسلم")
client.user.setStatus("كن رافع رأسك دائما ولا تستسلم")
});
